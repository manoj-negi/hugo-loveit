...
[params]
  ...
  [params.page]
    ...
    [params.page.comment]
      ...
      [params.page.comment.valine]
        ...
        # located in "assets/lib/valine/emoji/" directory
  ...
  [params.cdn]
    ...
    # ["jsdelivr.yml"]
    # located in "assets/data/cdn/" directory
    # you can store your own data files in the same path under your project:
    # "assets/data/cdn/"
    data = ""
...
The default CDN data file is located in `assets/data/cdn/` directory.
...
The default data of all supported social links is located in `assets/data/social.yaml`,
...
In `assets/css/_override.scss`, you can override the variables in `assets/css/_variables.scss` to customize the style.
